...
export const INITIAL_REGISTRATIONS: SupplierRegistration[] = [
  {
    ...
    workforce: "11-50",
    moq: "51-200",
    selectedCategories: ["tshirt_shirt"],
    status: "approved",
    ...
    profileDetails: {
      ...
      factoryBranding: {
        logoUrl: "/images/categories/tshirt_shirt.jpg",
        coverUrl: "/images/categories/tshirt_shirt.jpg",
  ...
  },
  {
    ...
    workforce: "1-10",
    moq: "1-50",
    selectedCategories: ["frock_skirt_blouse"],
    status: "pending",
  ...
  },
  {
    ...
    workforce: "1-10",
    moq: "1-50",
    selectedCategories: ["denim_trousers"],
    status: "rejected",
